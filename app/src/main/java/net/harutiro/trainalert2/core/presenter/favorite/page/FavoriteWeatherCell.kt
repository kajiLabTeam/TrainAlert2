package net.harutiro.trainalert2.core.presenter.favorite.page
...
import net.harutiro.trainalert2.features.Weather.entities.Max
import net.harutiro.trainalert2.features.Weather.entities.Min
import net.harutiro.trainalert2.features.Weather.entities.Temperature
...
fun PreviewPrefectureFavoriteWeatherCell() {
    ...
    val weather = Weather(
        ...
        forecasts = listOf(
            Forecast(
                date = "2021-10-23",
                image = net.harutiro.trainalert2.features.Weather.entities.Image(
                    title = "晴れ",
